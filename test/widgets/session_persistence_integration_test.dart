...
void main() {
  ...
  group('Session Persistence Integration Tests', () {
    ...
    testWidgets('User session persists across app restart',
    ...
    testWidgets('Device tracking persists across sessions',
        (WidgetTester tester) async {
    ...
    testWidgets('Multiple sign-ins update login count',
        (WidgetTester tester) async {
    ...
    testWidgets('Sign-out clears session completely',
        (WidgetTester tester) async {
    ...
    testWidgets('Soft-deleted users cannot restore session',
        (WidgetTester tester) async {
      // Verify that:
  ...
  group('Cross-Device Session Tests', () {
    testWidgets('Same user can have sessions on multiple devices',
        (WidgetTester tester) async {
      // Verify that:
    ...
    testWidgets('Device information is tracked correctly',
        (WidgetTester tester) async {
  ...
  group('Security and Logging Tests', () {
    testWidgets('Sign-in events are logged with device info',
        (WidgetTester tester) async {
    ...
    testWidgets('Sign-out is logged for audit trail',
        (WidgetTester tester) async {
